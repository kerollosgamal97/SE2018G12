          ...
          <div class="carousel-item" 	style="background-color:#00CED1;">
            <div class="container">
              <div class="carousel-caption">
                ...
                <p><a class="btn btn-lg btn-primary guest" href="customerpage.php" role="button" id="2">Join</a></p>
              </div>
            </div>
          </div>
          ...
          <div class="carousel-item">
            ...
            <div class="container">
              <div class="carousel-caption text-right">
                <h1>Coming soon</h1>
                <p>.....</p>
                <p><a class="btn btn-lg btn-primary gallery" href="#" role="button" id="3">Browse gallery</a></p>
              </div>
            </div>
          </div>
